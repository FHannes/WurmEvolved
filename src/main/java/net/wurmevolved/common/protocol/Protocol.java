package net.wurmevolved.common.protocol;

public class Protocol {

    // Client 3.54

    public static final int PACKET_STUNNED = 1;
    public static final int PACKET_CLIMBING = 2;
    public static final int PACKET_LOGIN = 3;
    public static final int PACKET_CREATURE_LAYER = 5;
    public static final int PACKET_HOST_HASH = 6;
    ...
    public static final int PACKET_MOVE_OBJECT = 84;
